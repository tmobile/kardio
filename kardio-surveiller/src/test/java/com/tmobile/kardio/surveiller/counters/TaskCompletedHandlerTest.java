...
/**
 * UT for TaskCompletedHandler class
 *
 */
public class TaskCompletedHandlerTest extends ProxyUtilTest{
	...
	public void testGetCounterMerticValue(){
		TaskCompletedHandler ss = new TaskCompletedHandler();
		...
		MockUp<DBQueryUtil> dqu = new MockUp<com.tmobile.kardio.surveiller.util.DBQueryUtil>() {
			@Mock
			public float getTotalTransaction(int envCountId){
				return (float) 5.00;
			}
		};
        try {
